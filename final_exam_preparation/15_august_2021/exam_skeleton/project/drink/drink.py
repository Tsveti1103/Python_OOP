...
class Drink(ABC):
    ...
    def portion(self, value):
        Validator.value_is_positive(value, "Portion cannot be less than or equal to zero!")
    ...
    def brand(self, value):
        Validator.value_is_not_empty_string(value, "Brand cannot be empty string or white space!")
        self.__brand = value
